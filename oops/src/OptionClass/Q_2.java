...
public class Q_2 {
    public static void main(String[] args) {
        ...
        // Check the length of the second name using Optional
        Optional<String> optionalName = Optional.ofNullable(names[1]);

        // Print the length if present, otherwise print a message
        optionalName.ifPresentOrElse(
            name -> System.out.println("Length of the second name: " + name.length()),
            () -> System.out.println("Second name is null, cannot determine length.")
        );
