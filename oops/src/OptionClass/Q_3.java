...
public class Q_3 {
    public static void main(String[] args) {
        ...
        // Check the length of the third name using Optional
        Optional<String> optionalName = Optional.ofNullable(names[2]);

        // Print the length if present, otherwise print a message
        optionalName.ifPresentOrElse(
            name -> System.out.println("Length of the third name: " + name.length()),
            () -> System.out.println("Third name is null, cannot determine length.")
        );
